---
title: Fata Morgana hakkında
description: The House in Fata Morgana görsel romanı hakkında bilgi veren bir sayfa.
icon: lucide/info
---
...
<img src="../images/dreamsoftherevenants.webp" alt="2019'da çıkan The House in Fata Morgana: Dreams of the Revenants edisyonu." width="250">
...
<img src="../images/requiemforinnocence-keyart.webp" alt="2015 ve 2019'da çıkan Requiem for Innocence'ın kapağı" width="250">
...
Hikaye genel olarak <span class="spoiler" data-description="Ana eserin 3. bölümünden bir karakterin ismini içeriyor">Jacopo</span> ve <span class="spoiler" data-description="Ana eserin önemli karakterlerinden birisinin ismini içeriyor">Morgana</span> ikilisinin ışığında ilerliyor, aynı zamanda <span class="spoiler" data-description="Ana eserden spoiler içeriyor">köşkün lanetlenmesine sebebiyet veren trajik olayları anlatıyor.</span> Ana eserden farklı olarak bu prequel bize 6 farklı kısa hikaye de sunuyor.
<hr>
### Reincarnation

Japonya'ya ilk olarak **The House in Fata Morgana -COLLECTED EDITION-** içerisinde çıkan ve sonrasında yeniden yapımın kısa hikayeleri içerisine dahil edilen **Reincarnation**, ana oyunun ilerisinde geçen *(sequel)* bir oyun olarak anılır. Bu kısa hikaye içerisinde yeni sanat tarzı ve tamamı seslendirilmiş metinler barındırıyor. Hikaye <span class="spoiler" data-description="Ana eserden spoiler içeriyor">ana oyundaki karakterlerin günümüz dünyasına reenkarne olmuş hâlini</span> anlatıyor.
<hr>
## Yan oyunlar

<figure style="float: right; margin-left: 1em;">
    <img src="../images/seventhlair-keyart.webp" alt="2013'de 1 Nisan şakası olarak çıkan Seventh Lair'ın kapağı." width="250px">
...
<figure style="float: left; margin-right: 1em; margin-left: -1.6em;">
    <img src="../images/erasmus-keyart.webp" alt="2011'de bedava olarak çıkış yapmış The Erasmus Two-Faced Stories'in kapağı." width="250px">
...
Aynı şekilde bu eser de **Seventh Lair**'da olduğu gibi **The House in Fata Morgana**'nın alternatif bir evreninde geçiyor. İlk hikaye 2011'de, <span class="spoiler" data-description="Ana eserin ilk kapısından bir karakterin ismini içeriyor.">Mell</span> karakterinin kendisini *"Sis Cadısı"* olarak tanıtan birisi tarafından gizemli bir e-posta almasıyla başlıyor. Cadı kendisi ve Strasbourg'daki Erasmus programına katılmış eski arkadaşları ile bir buluşma düzenliyor.
...
<img src="../images/dreamsoftherevenants.webp" width="150" class="no-lightbox">
</section>
| Platform | Puan | 
| :----------: | :----------: |
| Metacritic | 96 |
